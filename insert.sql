...
INSERT INTO Representations(date, lieu, nbPlaces, idSpectacle) VALUES
    (TIMESTAMP '2017-05-10 22:20:51', 'Paris', 100,
        (SELECT idSpectacle FROM Spectacles WHERE nom='Notre-Dame-de-Paris')),
    (TIMESTAMP '2017-06-02 21:00:00', 'Paris', 80,
        (SELECT idSpectacle FROM Spectacles WHERE nom='Le Cid')),
    (TIMESTAMP '2017-05-28 21:00:00', 'Paris', 100,
        (SELECT idSpectacle FROM Spectacles WHERE nom='Cyrano de Bergerac')),
    (TIMESTAMP '2017-06-01 22:00:00', 'Paris', 70,
        (SELECT idSpectacle FROM Spectacles WHERE nom='Hamlet')),
    (TIMESTAMP '2017-06-29 22:00:00', 'Paris', 2,
        (SELECT idSpectacle FROM Spectacles WHERE nom='Hamlet')),
    (TIMESTAMP '2017-05-08 22:00:00', 'Paris', 100,
        (SELECT idSpectacle FROM Spectacles WHERE nom='Notre-Dame-de-Paris'));
